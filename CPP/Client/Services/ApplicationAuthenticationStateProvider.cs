...
namespace CP.Client
{
    ...
    {
        private const string AuthenticationStateKey = "CP.Server.AuthenticationState";
        ...
        public override async Task<AuthenticationState> GetAuthenticationStateAsync()
        {
            ...
            try
            {
                ...
                {
                    identity = new ClaimsIdentity(state.Claims.Select(c => new Claim(c.Type, c.Value)), "CP.Server");
                }
            }
