...
namespace CPC.Components.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<CPC.Models.ApplicationUser> users;
        protected RadzenDataGrid<CPC.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(CPC.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(CPC.Models.ApplicationUser user)
        {
            try
            {
